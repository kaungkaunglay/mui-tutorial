...
const Footer = () => {
  return (
    <Box display={"flex"} flexDirection={"column"}>
            <CustomizedTypography  fontWeight={"bold"} fontSize={{lg: 30, md: 24, sm: 18, xs: 14}}  variant='h3' padding={10} textAlign={"center"}>
                Ready For Any Team Size
            </CustomizedTypography>
            <CustomizedTypography fontSize={{lg: 24, md: 20, sm: 16, md: 14}} variant='div' textAlign={"center"} padding={4}>
